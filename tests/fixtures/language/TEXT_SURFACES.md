...
- surface_id: cli-range-errors
  ...
  code_locator: "dict L36; hexagram L18,27–29; cast --seed validation; journal --hexagram validation"
  current_text: '"Hexagram number must be an integer from 1 to 64." / "Invalid style \"${style}\". Choose from: dx, tu, en, te, w" / "Invalid --seed \"${seed}\": expected a number." / "Invalid --hexagram \"${n}\": expected a number 1-${max}."'
  surface_class: cli-invalid-paths
