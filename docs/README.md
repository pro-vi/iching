...
| [Yarrow Ritual Vision](vision/yarrow-ritual-vision.md) | The yarrow stalk method — faithful 49-stalk math, braille-field animation, and pacing | Vision note; design direction, not yet implementation scope. |
