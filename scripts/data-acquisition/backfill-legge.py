...
def _emit_legge_module(
    ...
    out.append(" * Two documented Legge typography anomalies leave gaps: hex 39 (Kien)")
    out.append(" * appears under pair=[41]; hex 49 (Ko) under pair=[50, 51]. Hexes 39")
    out.append(" * and 49 are not keys here.")
    out.append(" */")
